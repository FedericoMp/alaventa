...
const Home = () => {
    return (
        <section id="Home" className="flex flex-col h-full">
            <Header/>
            <div className="flex-1 flex flex-col justify-center items-center bg-gradient-to-b from-indigo-500">
                ...
                <Link href="/productos" type="button" className="rounded-md bg-gray-950 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-600 flex justify-between align-middle max-w-fit">
                    Ver catálogo
